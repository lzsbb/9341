...
set network.lan.ipaddr='192.168.168.1'
...
set network.lte_4g.proto='dhcp'
set network.mobile_4g='interface'
set network.mobile_4g.ifname='eth2'
set network.mobile_4g.proto='dhcp'
