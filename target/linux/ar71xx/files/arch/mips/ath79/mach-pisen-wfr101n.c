...
#define PISEN_WFR101N_GPIO_I2S_SD		11
#define PISEN_WFR101N_GPIO_I2S_WS		12
#define PISEN_WFR101N_GPIO_I2S_CLK		13
...
static struct platform_device pisen_wfr101n_internal_codec = {
	.name		= "ath79-internal-codec",
	.id		= -1,
};

static struct platform_device pisen_wfr101n_spdif_codec = {
	.name		= "ak4430-codec",
	.id		= -1,
};
...
static void __init pisen_wfr101n_audio_setup(void)
{
	u32 t;
	...
	*/
	gpio_request(PISEN_WFR101N_GPIO_I2S_CLK, "I2S CLK");
	ath79_gpio_output_select(PISEN_WFR101N_GPIO_I2S_CLK, AR934X_GPIO_OUT_MUX_I2S_CLK);
	gpio_direction_output(PISEN_WFR101N_GPIO_I2S_CLK, 0);

	gpio_request(PISEN_WFR101N_GPIO_I2S_WS, "I2S WS");
	ath79_gpio_output_select(PISEN_WFR101N_GPIO_I2S_WS, AR934X_GPIO_OUT_MUX_I2S_WS);
	gpio_direction_output(PISEN_WFR101N_GPIO_I2S_WS, 0);

	gpio_request(PISEN_WFR101N_GPIO_I2S_SD, "I2S SD");
	ath79_gpio_output_select(PISEN_WFR101N_GPIO_I2S_SD, AR934X_GPIO_OUT_MUX_I2S_SD);
	gpio_direction_output(PISEN_WFR101N_GPIO_I2S_SD, 0);

	gpio_request(PISEN_WFR101N_GPIO_I2S_MCLK, "I2S MCLK");
	ath79_gpio_output_select(PISEN_WFR101N_GPIO_I2S_MCLK, AR934X_GPIO_OUT_MUX_I2S_MCK);
	gpio_direction_output(PISEN_WFR101N_GPIO_I2S_MCLK, 0);

	gpio_request(PISEN_WFR101N_GPIO_SPDIF_OUT, "SPDIF OUT");
	ath79_gpio_output_select(PISEN_WFR101N_GPIO_SPDIF_OUT, AR934X_GPIO_OUT_MUX_SPDIF_OUT);
	gpio_direction_output(PISEN_WFR101N_GPIO_SPDIF_OUT, 0);

	gpio_request(PISEN_WFR101N_GPIO_I2S_MIC_SD, "I2S MIC_SD");
	ath79_gpio_input_select(PISEN_WFR101N_GPIO_I2S_MIC_SD, AR934X_GPIO_IN_MUX_I2S_MIC_SD);
	gpio_direction_input(PISEN_WFR101N_GPIO_I2S_MIC_SD);
...
static void __init pisen_wfr101n_setup(void)
{
	...
	ath79_register_leds_gpio(-1, ARRAY_SIZE(pisen_wfr101n_leds_gpio) - 1,
...
MIPS_MACHINE(ATH79_MACH_PISEN_WFR101N, "PISEN_WFR101N", "PISEN_WFR101N",
	     pisen_wfr101n_setup);
